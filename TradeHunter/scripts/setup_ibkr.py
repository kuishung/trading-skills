"""One-time IBKR setup wizard for TradeHunter.
...
def step_write_ibc_files(creds: dict | None, paths: dict, secrets_path: Path) -> None:
    ...
    config_ini.write_text(f"""# IBC config for TradeHunter — generated by setup_ibkr.py
...
REM Launcher generated by TradeHunter setup_ibkr.py for {app_label} mode.
