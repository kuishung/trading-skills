"""Local dashboard server for TradeHunter.

FastAPI + WebSocket. Serves dashboard_intraday/web/index.html at
...
for _p in [str(_root)] + [str(_root / s) for s in
        ("scripts", "resources", "strategy", "execution",
         "journal", "review", "dashboard_intraday")]:
...
WEB_DIR = Path(__file__).resolve().parent / "web"   # dashboard_intraday/web/
...
app = FastAPI(title="TradeHunter dashboard", lifespan=lifespan)
