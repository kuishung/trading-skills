...
__version__ = "1.0.0"   # see changelog.md for history

import statistics
from datetime import time as dtime

from _common import get_rth_minute_bars  # noqa: E402  (scripts/_common.py)
from writer import journal  # noqa: E402  (journal/writer.py)
from signals import ema_series, split_pm_rth  # noqa: E402  (strategy/signals.py)
...
def evaluate(symbol: str, bars: list[dict], strat: Strategy) -> dict | None:
    ...
    # downstream can attribute outcomes to a specific rule-set when
    # review/stats.py buckets the data.
