...
REM %~dp0 = directory of this .bat file (trailing backslash). Stripping the
REM trailing backslash matches the IBC docs convention.
set IBC_PATH=%~dp0
...
if not defined TWSUSERID set TWSUSERID=
if not defined TWSPASSWORD set TWSPASSWORD=
set FIXUSERID=
set FIXPASSWORD=
set JAVA_PATH=
set HIDE=
